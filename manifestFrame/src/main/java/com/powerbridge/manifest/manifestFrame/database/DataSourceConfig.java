 ...
 * 
 */
package com.powerbridge.manifest.manifestFrame.database;
 ...
 */
@Configuration
@MapperScan(basePackages = "com.powerbridge.manifest.manifestFrame.database.mapper.primarySource", sqlSessionTemplateRef  = "primarySqlSessionTemplate")
