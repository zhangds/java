...
import org.interestTeam.model2.service.RedisService;
...
public class RedisServiceImpl implements RedisService{
    ...
    public UserDao getSession(String key,String userName) {
    	UserDao session = (UserDao) hmGet(key, userName);
        return session;
    }

    public void setSession(String key,String userName, UserDao session, long dayTime) {
        hmSet(key, userName, session);
        expire(key +":" + userName,  dayTime, TimeUnit.DAYS );
    }
