...
public class TestInfo {
	...
	public static void main(String[] args) {
		String url = "http://127.0.0.1:8080/flowDeploy/FlowWebEngine/getNodeInfo";
				//"http://127.0.0.1:8080/flowDeploy/FlowWebEngine/toNextFlowNode";
		//String json = "{staffno:\"1001\",flowId:\"1234\",workCaseId:\"202008050000006423\",serviceId:\"037003002003\"}";
		@SuppressWarnings("serial")
		Map<String,String> params = new HashMap<String, String>(){{
			put("staffno","1001");put("flowId","211");//CS202009180000014256//CS202009210000014769
			put("workCaseId","CS202009210000014786");put("serviceId","037003002003");
